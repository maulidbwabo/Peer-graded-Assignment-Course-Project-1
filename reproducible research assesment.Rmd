...
```{r}
qplot(stepsByDay1, xlab='Total steps per day', ylab='Frequency using binwith 500', binwidth=500)
```
...
```{r}
ggplot(data=averageStepsPerTimeBlock1, aes(x=interval, y=meanSteps)) +
    geom_line() +
